// @fbfrog -string directByteArrayToString -string directUbyteArrayToString -string indirectByteArrayToString -string indirectUbyteArrayToString -string p1 -string p4 -string p5 -nostring CHAR -string charArray
